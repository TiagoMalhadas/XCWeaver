...
import (
	...
	"github.com/TiagoMalhadas/xcweaver/internal/net/call"
	"github.com/TiagoMalhadas/xcweaver/internal/register"
	"github.com/TiagoMalhadas/xcweaver/internal/traceio"
	"github.com/TiagoMalhadas/xcweaver/runtime"
	"github.com/TiagoMalhadas/xcweaver/runtime/codegen"
	"github.com/TiagoMalhadas/xcweaver/runtime/deployers"
...
func (w *RemoteWeavelet) getAntipodeAgentInfo(ctx context.Context, name string) (*protos.GetAntipodeAgentInfoReply, error) {
	...
	fmt.Println("datastoreId getAntipodeAgentInfo: ", reply.GetDatastore())
	return reply, nil
}
