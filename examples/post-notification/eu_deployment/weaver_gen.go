...
func (s post_storage_europe_local_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 string, err error) {
	// Update metrics.
...
func (s post_storage_europe_client_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 string, err error) {
	// Update metrics.
	var requestBytes, replyBytes int
	begin := s.postMetrics.Begin()
...
ERROR: You generated this file with 'xcweaver generate' v0.5.24 (codegen
...
func (s post_storage_europe_reflect_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 string, err error) {
